...
const cardVariants={
  hidden: {scale: 0 },
  visible: {scale: 1 , originY: 0, transition:{ duration: .5}},
  exit: { scale: 0, originY: 0, transition:{ duration: .5}}
}
...
const ArticleDetails = (props) => {
  ...
  return (
    ...
    <motion.div layout variants={cardVariants} key={article.id} initial='hidden' animate='visible' exit='exit' className="col s12 l9 article-details">
      <h5>{article.title}</h5>
